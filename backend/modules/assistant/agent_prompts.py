...
AGENT_SYSTEM_PROMPT = (
    ...
    "- When the user asks about technical topics, methods, or best practices, "
    "use search_academic_papers to find relevant research papers.\n"
    "- Include paper references in your response as a 'References' section at the end.\n"
    "- Format each reference with title, authors, year, and DOI/URL link.\n"
    "- Use English search queries for best results on Semantic Scholar.\n"
