...
export const PulseGapFactorChart: React.FC<CardComponentProps> = () => {
  ...
  const option = useMemo((): EChartsOption => {
    ...
    return {
      title: { text: 'Pulse / Gap Factor', left: 'center', textStyle: { fontSize: 16 } },
      ...
      series: [{ type: 'bar', data: factors.map(f => f.value), itemStyle: { color: NEON_COLORS.purple } }],
...
export default PulseGapFactorChart;
