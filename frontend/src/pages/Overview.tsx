  ...
  return [
    {
      ...
      defaultLayouts: { md: { x: 0, y: 0, w: 5, h: 4, minW: 4, minH: 4, maxH: 4 } },
    },
    {
      id: 'risk-radar',
      title: '综合风险评估',
      ...
      defaultLayouts: { md: { x: 5, y: 0, w: 5, h: 4, minW: 4, minH: 4, maxH: 4 } },
    },
    {
      id: 'settlement',
      title: '沉降监测概况',
      ...
      defaultLayouts: { md: { x: 0, y: 4, w: 5, h: 4, minW: 4, minH: 4, maxH: 4 } },
    },
    {
      id: 'cracks',
      title: '裂缝监测概况',
      ...
      defaultLayout: { x: 6, y: 4, w: 6, h: 4, minW: 4, minH: 4, maxH: 4 },
      defaultLayouts: { md: { x: 5, y: 4, w: 5, h: 4, minW: 4, minH: 4, maxH: 4 } },
    },
    {
      id: 'temperature',
      title: '温度监测概况',
      ...
      defaultLayouts: { md: { x: 0, y: 8, w: 5, h: 4, minW: 4, minH: 4, maxH: 4 } },
    },
    {
      id: 'vibration',
      title: '振动监测概况',
      ...
      defaultLayouts: { md: { x: 5, y: 8, w: 5, h: 4, minW: 4, minH: 4, maxH: 4 } },
    },
  ];
}
