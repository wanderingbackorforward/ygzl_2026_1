...
| 触发关键词 | 自动调用 Skill | 说明 |
|-----------|---------------|------|
| **论文/研究文章** | `Codex-scientific-writer:scientific-writing` | IMRaD 结构，LaTeX + BibTeX，5+ 图表 |
| **文献综述/综述** | `Codex-scientific-writer:literature-review` | 系统化检索多数据库（PubMed/arXiv/bioRxiv），4+ 图表 |
| **假设生成** | `Codex-scientific-writer:hypothesis-generation` | 彩色框模板，XeLaTeX，4 页正文 + 附录，50+ 引用 |
| **市场研究/分析** | `Codex-scientific-writer:market-research-reports` | 50+ 页，25-30 可视化，McKinsey/BCG 风格 |
| **治疗方案** | `Codex-scientific-writer:treatment-plans` | 1-6 页，HIPAA 合规，SMART 目标 |
| **临床报告** | `Codex-scientific-writer:clinical-reports` | CARE/ICH-E3 指南，监管合规 |
| **研究海报** | `Codex-scientific-writer:latex-posters` | beamerposter/tikzposter，6+ 图表 |
| **演示文稿/幻灯片** | `Codex-scientific-writer:scientific-slides` | Nano Banana Pro AI，每页必有视觉元素 |
| **研究基金申请** | `Codex-scientific-writer:research-grants` | NSF/NIH/DOE/DARPA 格式，预算准备 |

### 辅助功能（按需触发）

| 触发场景 | 自动调用 Skill | 说明 |
|---------|---------------|------|
| **需要查找论文** | `Codex-scientific-writer:research-lookup` | Perplexity Sonar Pro，自动选模型 |
| **需要管理引用** | `Codex-scientific-writer:citation-management` | Google Scholar/PubMed 搜索，BibTeX 生成 |
| **需要生成图表** | `Codex-scientific-writer:scientific-schematics` | 神经网络架构、流程图、生物通路 |
| **需要通用图像** | `Codex-scientific-writer:generate-image` | FLUX/Gemini，照片/插图/概念图 |
| **需要转换文档** | `Codex-scientific-writer:markitdown` | PDF/DOCX/PPTX → Markdown |
| **论文转网页/视频** | `Codex-scientific-writer:paper-2-web` | Paper2Web/Paper2Video/Paper2Poster |
...
科学写作任务也适用 PUA 自动触发（参见全局 AGENTS.md）：
